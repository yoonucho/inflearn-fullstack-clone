						...
						courses.map((course: Course) => {
							...
							return (
								<TableRow key={course.id}>
									<TableCell>
										<Image src={course.thumbnailUrl || "/logo/inflearn.png"} alt={course.title} width={80} height={80} className="rounded bg-white border object-contain" />
									</TableCell>
									...
									<TableCell className="flex flex-col gap-2 justify-center h-full">
										...
										<Button onClick={() => router.push(`/course/${course.id}/edit/course_info`)} variant="outline" size="sm">
